    ...
    import('gsap').then((module) => {
      ...
      if (cloud) {
        gsapInstance.fromTo(
          cloud,
          { opacity: 0, y: 50 },
          { opacity: 1, y: 0, duration: 0.5, delay: 2, ease: 'power2.out' }
        );
        gsapInstance.to(cloud, {
          y: -10,
          duration: 1,
          repeat: -1,
          yoyo: true,
      ...
      <div className="w-full px-[10%] relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            >
              Custom Business Solutions to Drive Growth and Efficiency
            </motion.h1>
            <motion.p
            ...
            >
              Tailored Software to Solve Your Unique Challenges in 2025
            </motion.p>
            <motion.p
            ...
            >
              Transform your business with our custom software solutions. From CRM to AI-powered tools, we address your unique challenges and help you stay ahead in a digital-first world. Ready to streamline operations and boost growth?
            </motion.p>
            <motion.div
          ...
          {/* Right: Animated SVG (Digital Workspace with Interconnected Tools) */}
          <div className="md:w-1/2 flex justify-center">
            <svg width="500" height="400" viewBox="0 0 500 400" className="w-full max-w-[500px]">
              ...
              <g transform="translate(80, 80)">
                {/* Automation Gear */}
                <g className="automation-gear" transform="translate(0, 0)">
                ...
                {/* Security Shield */}
                <g className="security-shield" transform="translate(120, 0)">
                ...
                {/* Cloud */}
                <g className="cloud" transform="translate(240, 0)">
                  <path d="M60,40 Q70,30 80,40 Q90,30 100,40 Q110,50 100,60 Q110,70 100,80 Q90,90 80,80 Q70,90 60,80 Q50,90 40,80 Q30,70 40,60 Q30,50 40,40 Q50,30 60,40 Z" fill="#0F172A" stroke="#14B8A6" strokeWidth="2" />
                  <path d="M50,60 H90" stroke="#14B8A6" strokeWidth="2" />
                </g>
              </g>

    ...
    <section className="bg-gradient-to-b from-dark-950 to-dark-800 py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="w-full px-[10%] relative z-10">
        <div className="text-center mb-12">
          ...
          >
            Let’s build a user-friendly, high-performing mobile app that drives results.
          </motion.p>
          <motion.p
          ...
          >
            Contact us today for a free quote and discover how our mobile app development services can transform your business. Whether you need an iOS, Android, or cross-platform app, we’re here to help.
          </motion.p>
        </div>

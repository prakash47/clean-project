    ...
    <section className="bg-gradient-to-b from-dark-950 to-dark-800 py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="w-full px-[10%] relative z-10">
        <div className="text-center mb-12">
          ...
          >
            Let’s create a stunning UI/UX design and brand identity that captivates.
          </motion.p>
          <motion.p
          ...
          >
            Contact us today for a free quote and discover how our UI/UX design and branding services can elevate your digital presence. From intuitive designs to cohesive branding, we’re here to help.
          </motion.p>
        </div>

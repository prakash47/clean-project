...
export default function OurProcessSection() {
  const steps = [
    {
      title: 'Discovery',
      description: 'We dive deep into your goals, audience, and brand to create a tailored strategy.',
      icon: (
    ...
    {
      title: 'Design',
      description: 'Our designers craft visually stunning, mobile-responsive mockups that prioritize user experience (UX).',
      icon: (
        <svg width="40" height="40" viewBox="0 0 40 40">
    ...
    {
      title: 'Development',
      description: 'Our developers bring designs to life with clean code, SEO optimization, and performance enhancements.',
      icon: (
        <svg width="40" height="40" viewBox="0 0 40 40">
          <rect x="0" y="0" width="40" height="40" rx="5" fill="#14B8A6" />
    ...
    {
      title: 'Testing',
      description: 'We rigorously test for cross-browser compatibility, mobile performance, and Core Web Vitals to ensure flawless functionality.',
      icon: (
        <svg width="40" height="40" viewBox="0 0 40 40">
          <rect x="0" y="0" width="40" height="40" rx="5" fill="#14B8A6" />
    ...
    },
    {
      ...
      description: 'We launch your site and provide ongoing maintenance and SEO support to keep it ranking high.',
      icon: (
        <svg width="40" height="40" viewBox="0 0 40 40">
    ...
    <section className="bg-dark-900 py-16 md:py-24 relative overflow-hidden">
      <div className="w-full px-[10%] relative z-10">
        <div className="text-center mb-12">
          ...
          >
            We follow a streamlined process to deliver high-quality websites on time and within budget.
          </motion.p>
          <motion.p
          ...
          >
            Our web development process ensures every project is a success. From discovery to launch, we prioritize user-centric design, SEO best practices, and performance optimization to deliver websites that drive results.
          </motion.p>
        </div>
